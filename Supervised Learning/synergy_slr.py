...
data1['Interaction'] = data1['TV']*data1['Radio']    #Performing synergy combining two values to produce new one to increase the efficiency of the model
...
x = data1[['TV','Radio','Newspaper','Interaction']]
y = data1['Sales']
